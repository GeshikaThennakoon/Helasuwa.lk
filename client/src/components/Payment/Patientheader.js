...
export default function Patientheader() {
  ...
  return (
    <div className="fixed top-0 left-0 w-full z-50 flex items-center justify-between px-8 py-4 bg-gradient-to-r from-blue-900 to-indigo-900 shadow-md text-white">
